...
public class Pantalla1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("INGRESE SU NÚMERO DE CAJA");
    ...
    public int getUsuarioCuenta(){
        int j=0 ;
        if(!this.jTextField1.getText().trim().isEmpty()){
             try{
                 j = Integer.parseInt(this.jTextField1.getText().trim());
                 
             }catch(Exception e){
                 JOptionPane.showMessageDialog(this, "Ingrese una cuenta valida");
                 e.getMessage();
             }
        }else{
            JOptionPane.showMessageDialog(this, "Ingrese su numero de cuenta");
        }
        return j;
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(c.verificarCuenta(this.getUsuarioCuenta())){
            PantallaPin p = new PantallaPin();
            p.setVisible(true);
            this.dispose();
         }else{
